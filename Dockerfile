...
# 0.0.0.0 so the published port is reachable from the host; a bare `docker run`
# needs it (a container can't bind localhost). PORT comes from the Taskfile.
ENV HOST=0.0.0.0 DB_MIGRATE_ON_START=true
